...
class SportNewsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sportnews.index',compact('sportnews', 'pages'))
    ...
    public function create()
    {
        ...
        return view('sportnews.create',compact('pages', 'sponsors'));
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('bg_img')) {
            ...
            return redirect()->route('sportnews.index')
                        ->with('success','Sport News created successfully.');
            ...
            return redirect()->route('sportnews.index')
                        ->with('success','Sport News created successfully with news background.');

        } else {

            return redirect()->route('sportnews.create')
     ...
     *
     * @param  \App\SportNews  $sportNews
     * @return \Illuminate\Http\Response
     */
    public function show(SportNews $sportnews)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SportNews $sportnews)
    {
        ...
        return view('sportnews.edit',compact('sportnews', 'pages', 'sponsors'));
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, SportNews $sportnews)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(SportNews $sportnews)
    {
